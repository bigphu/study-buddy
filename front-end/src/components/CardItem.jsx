    ...
    <div className={`group w-[270px] bg-white rounded-3xl ${cardBorder} shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 overflow-hidden flex flex-col h-full`}>
      ...
      <div className="p-6 flex flex-col gap-4 grow bg-white relative z-10">
        ...
        <div>
          ...
          <p className="text-txt-placeholder h-6 text-sm font-roboto leading-relaxed line-clamp-1 flex items-center gap-1">
            {variant === 'session' ? (
              <>
                <Clock4 size={14} />
                {renderSessionTime()}
        ...
        {/* Metadata Row */}
        <div className="flex items-center justify-start gap-2 text-txt-dark text-sm font-outfit font-medium pt-3 border-t border-txt-placeholder/20">
